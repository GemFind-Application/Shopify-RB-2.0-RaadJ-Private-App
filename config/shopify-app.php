...
return [
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://raadj.app.theringbuilder.com/webhook/app-uninstalled')
        ],
    ],
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://raadj.app.theringbuilder.com/widgets/static/js/bundle.js'),
            'event' => env('SHOPIFY_SCRIPTTAG_1_EVENT', 'onload'),
            'display_scope' => env('SHOPIFY_SCRIPTTAG_1_DISPLAY_SCOPE', 'online_store')
        ],
        [
            'src' => env('SHOPIFY_SCRIPTTAG_2_SRC', 'https://raadj.app.theringbuilder.com/customCssFront/customFrontCss.js'),
